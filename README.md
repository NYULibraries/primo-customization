...
## Auto-generation of all possible Primo custom directives

To regenerate _custom/01NYU_INST-TESTWS01/js/03-autogenerated-directives.js_,
make any needed updates to _custom/01NYU_INST-TESTWS01/js/exlibris-template-cache-code.txt_
and re-run the file generation script:

```shell
node scripts/write-autogenerated-directives-file.js
```
