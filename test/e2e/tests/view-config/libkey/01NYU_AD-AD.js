const testCases = [
...

    {
        ...
        pathAndQuery : '/discovery/search?vid=[VID]&query=any,contains,art,AND&pfilter=rtype,exact,articles,AND&tab=default_slot&search_scope=CI_NYUAD_NYU&mode=advanced&offset=0',
    },
    {
        name                               : 'Art [advanced search: Material Type = Articles]',
        pathAndQuery                       : '/discovery/search?vid=[VID]&query=any,contains,art,AND&pfilter=rtype,exact,articles,AND&tab=default_slot&search_scope=CI_NYUAD_NYU&mode=advanced&offset=0',
...

    {
        ...
        pathAndQuery : '/discovery/search?vid=[VID]&query=any,contains,cdi_crossref_primary_10_1080_14672715_2021_1888307&tab=Unified_Slot&search_scope=DN_and_CI&offset=0',
    },
    {
        name         : 'docid: cdi_informaworld_taylorfrancis_310_1080_15596893_2022_2116781',
        pathAndQuery : '/discovery/search?vid=[VID]&query=any,contains,cdi_informaworld_taylorfrancis_310_1080_15596893_2022_2116781&tab=Unified_Slot&search_scope=DN_and_CI&offset=0',
    },
    {
