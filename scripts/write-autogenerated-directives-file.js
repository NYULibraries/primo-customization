...
const AUTOGENERATED_DIRECTIVES_FILE = path.join( ROOT, 'custom/01NYU_INST-TESTWS01/js/02-autogenerated-backup-custom-directives-function.js' );
const EXCLUDED_IDS = {
...
`    app.component( '${ convertKebabCaseToCamelCase( id ) }', {
    ...
    componentsJs += componentJs + EOL;
} );

componentsJs += '}' + EOL + EOL;
